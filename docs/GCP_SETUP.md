...
- Access to the GCP project (e.g., `rle-ruritania-petaluna`)
...
gcloud iam workload-identity-pools create "github-pool" \
  --project="rle-ruritania-petaluna" \
  --location="global" \
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-petaluna" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-petaluna.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-petaluna --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-petaluna.iam.gserviceaccount.com" \
  --project="rle-ruritania-petaluna" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-petaluna.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-petaluna.
